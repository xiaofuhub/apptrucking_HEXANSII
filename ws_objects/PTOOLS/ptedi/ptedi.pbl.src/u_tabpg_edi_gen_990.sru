HA$PBExportHeader$u_tabpg_edi_gen_990.sru
forward
global type u_tabpg_edi_gen_990 from u_tabpg_edi_gen
end type
end forward
...
global u_tabpg_edi_gen_990 u_tabpg_edi_gen_990
...
on u_tabpg_edi_gen_990.create
call super::create
end on

on u_tabpg_edi_gen_990.destroy
call super::destroy
end on
...
li_cnt ++
isa_tabpage[li_cnt] = 'u_tabpg_edi_990_in'
...
type dw_profile from u_tabpg_edi_gen`dw_profile within u_tabpg_edi_gen_990
integer x = 119
integer y = 200
end type

type st_title from u_tabpg_edi_gen`st_title within u_tabpg_edi_gen_990
integer x = 169
integer y = 100
end type

type tab_1 from u_tabpg_edi_gen`tab_1 within u_tabpg_edi_gen_990
end type
