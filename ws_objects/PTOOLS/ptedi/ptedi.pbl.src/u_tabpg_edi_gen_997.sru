HA$PBExportHeader$u_tabpg_edi_gen_997.sru
forward
global type u_tabpg_edi_gen_997 from u_tabpg_edi_gen
end type
end forward
...
global u_tabpg_edi_gen_997 u_tabpg_edi_gen_997
...
on u_tabpg_edi_gen_997.create
call super::create
end on

on u_tabpg_edi_gen_997.destroy
call super::destroy
end on
...
li_cnt ++
isa_tabpage[li_cnt] = 'u_tabpg_edi_997_in'
...
type dw_profile from u_tabpg_edi_gen`dw_profile within u_tabpg_edi_gen_997
end type

type st_title from u_tabpg_edi_gen`st_title within u_tabpg_edi_gen_997
end type

type tab_1 from u_tabpg_edi_gen`tab_1 within u_tabpg_edi_gen_997
end type
