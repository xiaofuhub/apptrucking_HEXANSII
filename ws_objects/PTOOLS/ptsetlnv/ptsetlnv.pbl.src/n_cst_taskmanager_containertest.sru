HA$PBExportHeader$n_cst_taskmanager_containertest.sru
$PBExportComments$ContainerTest (Task Manager from PBL map PTSetl) //@(*)[62346764|632:t]<nosync>
forward
global type n_cst_taskmanager_containertest from n_cst_taskmanager
end type
end forward

global type n_cst_taskmanager_containertest from n_cst_taskmanager
end type
global n_cst_taskmanager_containertest n_cst_taskmanager_containertest
...
on n_cst_taskmanager_containertest.create
TriggerEvent(this, "constructor")
end on

on n_cst_taskmanager_containertest.destroy
...
SetNavigationName( 1, "Entry to ContainerTest1")
SetIsEntry( 1)
SetDestinationName( 1, "w_containertest")
SetWindowType( 1, response!)
SetNavigationName( 2, "ContainerTest to Exit1")
SetSourceName( 2, "w_containertest")
