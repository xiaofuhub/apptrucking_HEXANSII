HA$PBExportHeader$n_cst_appeon_constant.sru
forward
global type n_cst_appeon_constant from nonvisualobject
end type
end forward

global type n_cst_appeon_constant from nonvisualobject autoinstantiate
end type

type variables
//ptcore.pbl(n_cst_appmanager_trucking)
//Constant String cs_User_PTADMIN = "PTADMIN"//invoke only in the instant n_cst_appmanager_trucking
 
//ptcore.pbl(n_cst_privsmanager)  110
...
//ptcore.pbl(u_cst_privs)//invoke only in the instant of u_cst_privs
/*
...
constant string cs_Entry = "entry.bmp"//replace cs_Entry = "entry.bmp"
/*//invoke only in the instant of u_cst_privs
...
//ptcorenv.pbl(n_cst_beo_shipment) 23
...
/* invoke only in the instant of n_cst_bso_liveload
...
/* invoke by global variable n_cst_constants
...
/* invoke only in the instant of n_cst_dragservice_dw
...
//ptcorenv.pbl(n_cst_eventconfirmationoptions) 11
// ROW CONSTANTS
...
//ptcorenv.pbl(n_cst_eventmanager) 27
...
/* invoke only in the instant of n_cst_eventtask
CONSTANT int eventtask_ci_Result_Error = -1//replace  ci_Result_Error = n_cst_eventmanager.ci_Result_Error
CONSTANT int eventtaskci_Result_Success = 1//replaceci_Result_Success = n_cst_eventmanager.ci_Result_Success
CONSTANT int eventtaskci_Result_SuccessNotComplete = 0//replace ci_Result_SuccessNotComplete = n_cst_eventmanager.ci_Result_SuccessNotComplete
 */

//ptcorenv.pbl(n_cst_helptopic)
/* invoke only in the instant of n_cst_helptopic
...
/*invoke only in the instant of n_cst_privileges
...
//ptcorenv.pbl(n_cst_referencelist) 1
Constant String  cs_ReferenceType = "REFERENCETYPE"
 
//ptcorenv.pbl(n_cst_scheduledata)
/*invoke only in the instant of n_cst_scheduledata
...
/*invoke only in the instant of n_cst_settings
...
/*invoke only in the instant of n_cst_valuelist
Constant String cs_ValueColumn = "Value"
 */
 
//ptdyn.pbl(n_cst_bso_dynamicobjectmanager)
/*invoke only in the instant of n_cst_bso_dynamicobjectmanager
...
/*invoke only in the instant of n_cst_dwsrv_mouseover
...
/*invoke only in the instant of n_cst_dwsrv_restrict
...
/*invoke only in the instant of n_cst_restrictioncriteria
...
/*invoke only in the instant of w_dwapplylink
...
//ptdyn.pbl(w_dwlink)
/*invoke only in the instant of w_dwlink
...
/*invoke only in the instant of w_dwproperties
...
/*invoke only in the instant of w_infoflag
...
/*invoke only in the instant of w_quickmatch
...
/*invoke only in the instant of w_savedefinitionas
...
/*invoke only in the instant of w_autoreposequipmentinput
Constant  String cs_MsgHdr = "Auto Route Repos"
 */
 
//ptdispwn.pbl(w_itin) 10?
...
//ptdispnv.pbl(n_cst_bso_dispatch) 8?
...
/* invoke only in the instant of u_cst_eventrouting_shipment
Constant Int ci_NumIP = 0
*/
 
//ptdisp.pbl(u_tab_intermodalshipment) 5
...
/* invoke only in the instant of u_cst_employeedivisiondefaults
...
/*invoke only in the instant of n_cst_bso_imagemanager
...
/*invoke only in the instant of n_cst_errorlog_manager
Constant String cs_ErrorRemedy_EDI = "n_cst_ErrorRemedy_edi"
*/
 
//ptdatanv.pbl(n_cst_notemanager)
/*invoke only in the instant of n_cst_notemanager
CONSTANT String cs_Delimiter = "/^\"
*/
 
//ptdatanv.pbl(n_cst_pegasus_print)
/*invoke only in the instant of n_cst_pegasus_print
...
/*invoke only in the instant of n_cst_presentation_state
...
/*invoke only in the instant of u_tab_companydetail
...
/*invoke only in the instant of n_cst_equipmentposting
...
/*invoke only in the instant of n_cst_presentation_equipment
...
/*invoke only in the instant of n_cst_ptrailtracemanager
CONSTANT String cs_RailTraceIniFileName = "railtrace.ini"
*/
 
//ptequip.pbl(w_equip_messagebox) 3
...
/*invoke only in the instant of n_cst_syssettings
...
/*invoke only in the instant of u_cst_syssettings_enumerated_cbx
...
//ptpropnv.pbl(n_cst_setting_accpkgs) 2
...
/*invoke only in the instant of n_cst_setting_allowrelinking
Constant String cs_Relink = "Relink"
Constant String cs_Reload = "Reload"
*/
 
//ptpropnv.pbl(n_cst_setting_autoroutedefaulttype)
/*invoke only in the instant of n_cst_setting_autoroutedefaulttype
...
//ptpropnv.pbl(n_cst_setting_defaultitinerarybutton) 10
...
/*invoke only in the instant of n_cst_setting_defaultnewshipbutton
...
//ptpropnv.pbl(n_cst_setting_edi204version) 2
...
//ptpropnv.pbl(n_cst_setting_eventlistdisplay)  3
//Constant String cs_Driver = "DRIVER"//replace with n_cst_eventconfirmationoptions.cs_Driver = "DRIVER"
...
/*invoke only in the instant of n_cst_setting_imagetitlequadrant
...
/*invoke only in the instant of n_cst_setting_invoicebillalign
CONSTANT String cs_LeftSide  = "Left Side"
CONSTANT String cs_RightSide = "Right Side"
*/
 
//ptpropnv.pbl(n_cst_setting_invoicesize)
/*invoke only in the instant of n_cst_setting_invoicesize
...
/*invoke only in the instant of n_cst_setting_perdiemchargesformat
...
/*invoke only in the instant of n_cst_setting_settlementsmileagetype
...
/*invoke only in the instant of n_cst_setting_shipnoteformat
...
//ptroute.pbl(gc_routing) to global 2
// direct invoke
constant long PARTIAL_MATCH = 0
constant long EXACT_MATCH = 1
/*invoke only in the instant of gc_routing
...
//ptroute.pbl(n_cst_routing) 1
//direct invoke
CONSTANT String  cs_Locater_State = "STATE"
/*invoke only in the instant of n_cst_routing
CONSTANT String  cs_Locater_State = "STATE"
...
/*invoke only in the instant of w_routemanager
...
//ptlink.pbl(n_cst_bso_document_manager) 52
...
/*invoke only in the instant of n_cst_clipboard
...
/*invoke only in the instant of n_cst_document
...
/*invoke only in the instant of n_cst_emailmessage
...
/*invoke only in the instant of n_cst_messagedata
...
/*invoke only in the instant of u_dw_attachimages
//Constant String cs_Color_Disabled = "78682240"//replace with  u_tab_companydetail.cs_Color_Disabled
*/
 
//ptnote.pbl(u_dw_companycontact_detail)
/*invoke only in the instant of u_dw_companycontact_detail
//Constant String cs_Color_Disabled = "78682240"//replace with  u_tab_companydetail.cs_Color_Disabled
*/
 
//ptedi.pbl(n_cst_bso_edi_manager) 4
Constant Int ci_MessageStatus_Pending = 0
Constant Int ci_MessageStatus_Processed = 1
Constant Int ci_MessageStatus_Canceled = -2
 
//ptedi.pbl(n_cst_bso_edimanager) 94
...
/*invoke only in the instant of n_cst_bso_edimanager_camir
...
/*invoke only in the instant of n_cst_edi_transaction
Constant string cs_transaction_edicache = 'd_edi'
*/
 
//ptedi.pbl(n_cst_ediexportshipmentmanager) 4
//direct invok
...
/*invoke only in the instant of n_cst_ediexportshipmentmanager
...
//ptedi.pbl(n_cst_edishipment_manager) 16
...
/*invoke only in the instant of n_cst_edishipment_manager_chrobinson
Constant String cs_CHRobinsonTLScac = "RBTW"
*/
 
//ptedi.pbl(n_cst_edishipment_manager_chrobinson_int)
/*invoke only in the instant of n_cst_edishipment_manager_chrobinson_int
Constant String cs_CHRobinsonIntScac = "RBIN"
*/

//ptedi.pbl(n_cst_edishipment_manager_evergreen)
/*invoke only in the instant of n_cst_edishipment_manager_evergreen
Constant String cs_EvergreenScac = "EVERGREEN"
*/
 
//ptedi.pbl(n_cst_edishipment_manager_hubgroup)
/*invoke only in the instant of n_cst_edishipment_manager_hubgroup
...
/*invoke only in the instant of n_cst_edishipment_manager_jb_hunt
Constant String cs_JBHuntScac = "HJBT"
*/
 
//ptedi.pbl(n_cst_edishipment_manager_maersk)
/*invoke only in the instant of n_cst_edishipment_manager_maersk
Constant String cs_MaerskScac = "MAEU"
*/
 
//ptedi.pbl(n_cst_edishipment_manager_nyklogistics)
/*invoke only in the instant of n_cst_edishipment_manager_nyklogistics
...
//ptmblcom.pbl(n_cst_bso_communication_manager) 2
/*invoke only in the instant of n_cst_bso_communication_manager 
*/
...
/*invoke only in the instant of n_cst_bso_communication_qualcomm 
...
/*invoke only in the instant of w_communication_manager 
...
/*invoke only in the instant of w_communication_outbound 
Constant String cs_Template_Directions = "directns.doc"
*/
 
//ptsetlwn.pbl(w_settlementbatchmanager)
/*invoke only in the instant of w_settlementbatchmanager 
...
//ptbillnv.pbl(n_cst_accountingdata) 2
...
/*invoke only in the instant of n_cst_acctlink_quickbooks_direct 
...
//ptbillnv.pbl(n_cst_batchsrv_sap) 1
//direct invoke
Constant String cs_STATUS_MANDATORY = "M"
/*invoke only in the instant of n_cst_batchsrv_sap 
...
/*invoke only in the instant of n_cst_edi_export_transportgold 
...
/*invoke only in the instant of n_cst_invoicemanager 
...
/*invoke only in the instant of w_shiptype_manager 
...
/*invoke only in the instant of u_event_bracketing 
...
//ptsetlnv.pbl(n_cst_beo_amountowed) 3
...
//ptsetlnv.pbl(n_cst_beo_amounttemplate) 17
...
//ptsetlnv.pbl(n_cst_beo_amounttype) 7
...
//ptsetlnv.pbl(n_cst_beo_transaction) 21
...
//ptsetlnv.pbl(n_cst_bso_fueltax) 14
...
/* invoke only in the instant of n_cst_bso_transactionmanager
...
/* invoke only in the instant of n_cst_presentation_amounttype
integer ii_category=3//replace ii_category=n_cst_constants.ci_category_both
*/
 
//ptrating.pbl(n_cst_bso_rating) 269
...
//ptrating.pbl(n_cst_bso_zonemanager) 12
...
//ptwininet.pbl(n_cst_wininet_ftp) 5
...
/* invoke only in the instant of pfc_n_cst_color 
...
/* invoke only in the instant of pfc_n_cst_dropdown 
...
/* invoke only in the instant of pfc_n_cst_dwcache 
// -- Style Constants.
...
/* invoke only in the instant of pfc_n_cst_error 
// Style constants.
...
/* invoke only in the instant of pfc_n_cst_luw 
Constant String ALL_OBJECTS = ''
*/
 
//pfcapsrv.pbl(pfc_n_cst_lvsrv_datasource)
/* invoke only in the instant of pfc_n_cst_lvsrv_datasource 
...
/* invoke only in the instant of pfc_n_cst_nodecomparebase 
...
/* invoke only in the instant of pfc_n_cst_security 
...
/* invoke only in the instant of pfc_n_cst_tmgmultiple 
constant integer TRIGGEREVENT = 0
constant integer POSTEVENT = 1
*/
 
//pfcapsrv.pbl(pfc_n_cst_tmgsingle)
/* invoke only in the instant of pfc_n_cst_tmgsingle 
...
/* invoke only in the instant of pfc_n_cst_tvsrv_levelsource 
...
/* invoke only in the instant of pfc_n_cst_dssrv 
...
/* invoke only in the instant of pfc_n_cst_dwsrv 
// Note: The constant DEFAULT=0 is used in descendants.
//constant integer DEFAULT = 0 //replace with pfc_n_cst_error.DEFAULT
...
/* invoke only in the instant of pfc_n_cst_dwsrv_filter 
...
/* invoke only in the instant of pfc_n_cst_dwsrv_linkage 
...
/* invoke only in the instant of pfc_n_cst_dwsrv_resize 
...
//pfcdwsrv.pbl(pfc_n_cst_dwsrv_rowselection) 3
//Style constants:
...
/* invoke only in the instant of pfc_n_cst_dwsrv_sort 
// Style constants.
// Defined in ancestor - constant integer DEFAULT = 0
...
/* invoke only in the instant of pfc_n_ds 
// - Common return value constants:
...
/* invoke only in the instant of pfc_u_base 
// - Common return value constants:
//constant integer   SUCCESS = 1//replace with pfc_n_base.SUCCESS
//constant integer   FAILURE = -1//replace with pfc_n_base.FAILURE
//constant integer   NO_ACTION = 0//replace with pfc_n_base.NO_ACTION
...
/* invoke only in the instant of pfc_u_calculator 
...
/* invoke only in the instant of pfc_u_calendar 
...
/* invoke only in the instant of pfc_u_dw 
// - Common return value constants:
//constant integer   SUCCESS = 1//replace with pfc_n_base.SUCCESS
//constant integer   FAILURE = -1//replace with pfc_n_base.FAILURE
//constant integer   NO_ACTION = 0//replace with pfc_n_base.NO_ACTION
...
/* invoke only in the instant of pfc_u_lvs 
//Constant Integer CONTINUE_ACTION = 1//replace with pfc_n_base.CONTINUE_ACTION
//Constant Integer PREVENT_ACTION = 0//replace with pfc_n_base.PREVENT_ACTION
//Constant Integer NO_ACTION = 0//replace with pfc_n_base.NO_ACTION
...
/* invoke only in the instant of pfc_u_progressbar 
...
/* invoke only in the instant of pfc_u_st_splitbar 
...
/* invoke only in the instant of pfc_u_tab 
// - Common return value constants:
//constant integer   SUCCESS = 1//replace with pfc_n_base.SUCCESS
//constant integer   FAILURE = -1//replace with pfc_n_base.FAILURE
//constant integer   NO_ACTION = 0//replace with pfc_n_base.NO_ACTION
...
/* invoke only in the instant of pfc_u_tvs 
//Constant Integer CONTINUE_ACTION = 1//replace with pfc_n_base.CONTINUE_ACTION
//Constant  Integer PREVENT_ACTION = 0//replace with pfc_n_base.PREVENT_ACTION
//Constant Integer NO_ACTION = 0//replace with pfc_n_base.NO_ACTION
...
/* invoke only in the instant of pfc_w_master 
// - Common return value constants:
//constant integer   SUCCESS = 1//replace with pfc_n_base.SUCCESS
//constant integer   FAILURE = -1//replace with pfc_n_base.FAILURE
//constant integer   NO_ACTION = 0//replace with pfc_n_base.NO_ACTION
...
/* invoke only in the instant of pfc_n_cst_debug 
...
/* invoke only in the instant of pfc_u_tabpg_dwproperty_services 
...
//pfcwnsrv.pbl(pfc_n_cst_resize) 38
// Predefined resize constants.
...
/* invoke only in the instant of pfc_n_cst_winsrv_statusbar 
...
/* invoke only in the instant of n_cst_anyarraysrv 
...
//pfemain.pbl(u_tab)
/* invoke only in the instant of u_tab 
Constant String       cs_myType = "tab"
*/
//how_srve.pbl(n_cst_beo)
Constant Integer	ci_ActionSource_User = 0
Constant Integer	ci_ActionSource_System = 1

Constant Boolean	cb_UserField = FALSE
Constant Boolean	cb_SystemField = TRUE

Public Constant Boolean	cb_Restricted = TRUE
Public Constant Boolean	cb_Unrestricted = FALSE

Constant Integer	ci_DescribeType_Default = 0
Constant Integer	ci_DescribeType_Short = 1
Constant Integer	ci_DescribeType_Long = 2

Constant String	cs_RejectEdit_NotAuthorized = &
	"You are not authorized to make this change."

Constant String	cs_RejectEdit_Invalid = &
	"The value you have entered is invalid."

Constant String	cs_RejectEdit_Negative = &
	"The value for this field cannot be negative."

Constant String	cs_RejectEdit_Error = &
	"Could not process request."

end variables

on n_cst_appeon_constant.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_cst_appeon_constant.destroy
