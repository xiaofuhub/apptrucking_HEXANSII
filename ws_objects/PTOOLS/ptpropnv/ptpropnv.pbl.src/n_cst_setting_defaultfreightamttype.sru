HA$PBExportHeader$n_cst_setting_defaultfreightamttype.sru
forward
global type n_cst_setting_defaultfreightamttype from n_cst_syssettings_dropdownchoices
end type
end forward

global type n_cst_setting_defaultfreightamttype from n_cst_syssettings_dropdownchoices
end type
global n_cst_setting_defaultfreightamttype n_cst_setting_defaultfreightamttype
...
lnv_settings.of_GetSetting(98,la_Value)
...
This.of_SetSetting(98,la_Value,lnv_settings.cs_datatype_long)

Return 1
end function

on n_cst_setting_defaultfreightamttype.create
call super::create
end on

on n_cst_setting_defaultfreightamttype.destroy
call super::destroy
end on
...
is_PropertyTextlabel = "Default Freight Amount Type."

n_cst_Presentation_AmountType lnv_PresentationAmountType
n_cst_String lnv_String

lnv_PresentationAmountType.Dynamic of_GetByItemType(n_cst_constants.cs_itemtype_freight,isa_Types[])
