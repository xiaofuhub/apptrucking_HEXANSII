HA$PBExportHeader$w_companyinvoicetransfersettings.srw
forward
global type w_companyinvoicetransfersettings from w_response
end type
type tab_invoice from u_tab_invoicetransfer within w_companyinvoicetransfersettings
end type
type tab_invoice from u_tab_invoicetransfer within w_companyinvoicetransfersettings
end type
type cb_ok from commandbutton within w_companyinvoicetransfersettings
end type
type cb_save from commandbutton within w_companyinvoicetransfersettings
end type
type dw_1 from u_dw_emailinvoicetoggle within w_companyinvoicetransfersettings
end type
end forward
...
global w_companyinvoicetransfersettings w_companyinvoicetransfersettings
...
on w_companyinvoicetransfersettings.create
int iCurrent
call super::create
...
on w_companyinvoicetransfersettings.destroy
call super::destroy
...
type cb_help from w_response`cb_help within w_companyinvoicetransfersettings
end type
