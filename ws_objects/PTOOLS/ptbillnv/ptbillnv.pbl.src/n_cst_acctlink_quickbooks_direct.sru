HA$PBExportHeader$n_cst_acctlink_quickbooks_direct.sru
...
This is what QB thinks is the FullName when it$$HEX1$$1920$$ENDHEX$$s doing the filtering:
"1200 $$HEX2$$b7002000$$ENDHEX$$Accounts Receivable$$HEX1$$1d20$$ENDHEX$$
This string is greater than $$HEX1$$1c20$$ENDHEX$$1200$$HEX1$$1d20$$ENDHEX$$, but less than $$HEX1$$1c20$$ENDHEX$$1201$$HEX1$$1d20$$ENDHEX$$.  
...
However, please note that end user would need to have $$HEX1$$1c20$$ENDHEX$$Use account number$$HEX2$$1d202000$$ENDHEX$$set in preferences
...
Then do #1 if it$$HEX1$$1920$$ENDHEX$$s false, or #2 or #3 if it$$HEX1$$1920$$ENDHEX$$s true.
