HA$PBExportHeader$u_dw_transactiondetail.sru
$PBExportComments$TransactionDetail (Data Control from PBL map PTSetl) //@(*)[83518298|351]
forward
global type u_dw_transactiondetail from u_dw
end type
end forward
...
string DataObject="d_transactiondetail"
...
global u_dw_transactiondetail u_dw_transactiondetail
...
protected n_cst_bso_transactionmanager in_transactionmanager //@(*)[83521278|352]
//@(text)--
...
public function n_cst_bso_transactionmanager GetTransactionmanager ();//@(*)[83521278|352:g]<nosync>//@(-)Do not edit, move or copy this line//
...
public function Integer SetTransactionmanager (n_cst_bso_transactionmanager an_transactionmanager);//@(*)[83521278|352:s]<nosync>//@(-)Do not edit, move or copy this line//
//@(text)(recreate=yes)<body>
...
on u_dw_transactiondetail.destroy
call u_dw::destroy
end on
