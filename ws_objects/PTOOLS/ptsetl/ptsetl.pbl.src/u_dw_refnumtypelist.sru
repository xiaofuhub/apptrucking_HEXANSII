HA$PBExportHeader$u_dw_refnumtypelist.sru
$PBExportComments$RefnumTypeList (Data Control from PBL map PTSetl) //@(*)[72270922|663]
forward
global type u_dw_refnumtypelist from u_dw
end type
end forward
...
string DataObject="d_dlkc_refnumtype"
boolean HScrollBar=true
boolean HSplitScroll=true
end type
global u_dw_refnumtypelist u_dw_refnumtypelist
...
on u_dw_refnumtypelist.destroy
call u_dw::destroy
end on

event constructor;//@(data)(recreate=yes)<GenerationOptions>
SetUILink(TRUE)
inv_uilink.SetClass("n_cst_beo_refnumtype")
inv_uilink.SetDLK("n_cst_dlkc_refnumtype")
of_SetTransObject(SQLCA)
this.SetUseTaskRetrieve(FALSE)
//@(data)--


n_cst_Presentation_refNumType  lnv_Presentation
...
IF gnv_App.inv_CacheManager.of_GetCache ( "n_cst_dlkc_refnumtype", lnv_Cache ) = 1 THEN
