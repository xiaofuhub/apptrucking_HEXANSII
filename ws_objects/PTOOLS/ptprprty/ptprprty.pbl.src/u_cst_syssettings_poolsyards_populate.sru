HA$PBExportHeader$u_cst_syssettings_poolsyards_populate.sru
$PBExportComments$ZMC
forward
global type u_cst_syssettings_poolsyards_populate from u_cst_syssettings_generic_populate
end type
end forward
...
global u_cst_syssettings_poolsyards_populate u_cst_syssettings_poolsyards_populate
...
on u_cst_syssettings_poolsyards_populate.create
int iCurrent
call super::create
end on

on u_cst_syssettings_poolsyards_populate.destroy
call super::destroy
end on

type uo_1 from u_cst_syssettings_generic_populate`uo_1 within u_cst_syssettings_poolsyards_populate
integer height = 1248
end type
...
IF isValid ( lnv_Co ) THEN
	...
	ELSE
		...
		MessageBox ( "Pools and Yards", "Any company selected here must have a code-name assigned to it."  )
	END IF
