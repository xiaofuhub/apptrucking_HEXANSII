HA$PBExportHeader$n_cst_eventtask_equipmentposting.sru
forward
global type n_cst_eventtask_equipmentposting from n_cst_eventtask
end type
end forward

global type n_cst_eventtask_equipmentposting from n_cst_eventtask
end type
global n_cst_eventtask_equipmentposting n_cst_eventtask_equipmentposting
...
on n_cst_eventtask_equipmentposting.create
call super::create
end on

on n_cst_eventtask_equipmentposting.destroy
call super::destroy
end on

event constructor;call super::constructor;is_taskdescription = 'This is the process that generates equipment postings for the purpose of equipment matching.'
is_Tabpagelabel = "Equipment Posting"
