...
// CHANGED TO
// this may 15 2003 in an attemp to prevent hung instances of the app visible in the windows task manager
// after closing the app.

// this didn't work. it never went into the destructor of the app
