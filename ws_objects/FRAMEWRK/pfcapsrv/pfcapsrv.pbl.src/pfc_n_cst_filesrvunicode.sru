...
Function boolean FindNextFileW (ulong handle, ref os_finddata findfiledata) library "KERNEL32.DLL"
...
//////////////////////////////////////////////////////////////////////////////
//
//	Copyright $$HEX2$$a9002000$$ENDHEX$$1995-1997 Sybase, Inc. and its subsidiaries.  All rights reserved.
...
lul_Handle = FindFirstFileW(as_AltFileName, lstr_FindData)
...
lul_Handle = FindFirstFileW(as_LongFileName, lstr_FindData)
If lul_Handle <= 0 Then Return ""
FindClose(lul_Handle)
