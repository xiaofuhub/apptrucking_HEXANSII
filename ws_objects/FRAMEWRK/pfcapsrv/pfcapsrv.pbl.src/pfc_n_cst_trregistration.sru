...
For li_idx = 1 To li_upper
	If IsValid (istr_trans[li_idx].tr_object) then
		If Not of_IsAllowSQLCADestroy() Then
			If IsValid(SQLCA) Then
				If istr_trans[li_idx].tr_object = SQLCA Then
		...
		ltr_object = istr_trans[li_idx].tr_object
