...
//
//	Description:  
//	Event to provide isolation to the Shared variable.  Used prior to displaying
// the popup menu.
//
//////////////////////////////////////////////////////////////////////////////
//	
...
//
//	Description: 
//	The of_CheckRequiredError has found a column missing data.  This gives the 
// opportunity to better handle the situation.
//
// Note:
// If return 0 is used, you should also notify the user of the error condition.
//
//////////////////////////////////////////////////////////////////////////////
//	
//	Revision History
...
//	Version
//	5.0   Initial version
// 6.0.01 Enhanced to call stub function which allows for more flexibility and
// 		control.
//
//////////////////////////////////////////////////////////////////////////////
//
...
//
// ****** NOTE: THIS CODE HAS BEEN MODIFIED BY PROFIT TOOLS TO FIX A BUG.
//        SEE DESCRIPTION BELOW.  THIS HAD TO BE CHANGED HERE DUE TO OFR
//        LAYER CALL TO SUPER.
//
//////////////////////////////////////////////////////////////////////////////
//	
...
integer	li_rc
//w_master	lw_parent	**THIS IS A PFC BUG, CAUSING A CRASH ON NON-PFC WINDOWS.
//								**SEE ALSO THE DYNAMIC of_GetCloseStatus call, below.
window		lw_parent
...
//		If lw_parent.of_GetCloseStatus() Then  **PFC VERSION

		If lw_parent.Dynamic of_GetCloseStatus() Then
